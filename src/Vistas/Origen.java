...
public class Origen extends javax.swing.JFrame {
    ...
    CModelosOrigen modelos = new CModelosOrigen();
    ...
    private void limpiar_tabla() {
        DefaultTableModel modelTabla
                = (DefaultTableModel) jTorigen.getModel();
    ...
    private int lee_fila_seleccionada() {
        ...
        if (modelTabla.getRowCount() != 0) {//tabla con filas
            if (jTorigen.getSelectedRow() != -1) {
                id = Integer.parseInt((String) modelTabla.getValueAt(jTorigen.getSelectedRow(), 0));
    ...
    private void initComponents() {
        ...
        jTorigen.setBackground(new java.awt.Color(153, 153, 255));
        jTorigen.setForeground(new java.awt.Color(51, 51, 51));
