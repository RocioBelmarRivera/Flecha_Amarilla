...
public class JFConsulta10 extends javax.swing.JFrame {
    ...
    private void lee_datos() {
        ...
        try {
            //3.leer los datos
            resultados = modelos.busca_objetos_model9();
            //4. limpiar tabla
            limpiar_tabla();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("10- Muestre todos los viajes que haya realizo un autobús del modelo MONARCA:   ");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id_autobus", "matricula", "capacidad", "id_ruta", "km", "costo", "dia", "mes", "año", "origen", "destino"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFConsulta10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFConsulta10().setVisible(true);
            }
        });
    }
