...
public class JFConsulta9 extends javax.swing.JFrame {
    ...
    private void lee_datos() {
        ...
        try {
            //3.leer los datos
            resultados = modelos.busca_objetos_model8();
            //4. limpiar tabla
            limpiar_tabla();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("9- Muestre las rutas donde al menos un cliente la haya pagado con efectivo.  ");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id_ruta", "km", "costo", "dia", "mes", "año", "Origen", "Destino"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFConsulta9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFConsulta9().setVisible(true);
            }
        });
    }
