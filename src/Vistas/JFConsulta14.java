...
public class JFConsulta14 extends javax.swing.JFrame {
    ...
    private void lee_datos() {
        ...
        try {
            //3.leer los datos
            resultados = modelos.busca_objetos_model13();
            //4. limpiar tabla
            limpiar_tabla();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("14- Muestre los asientos disponibles del camión que vaya a la ruta cdmx – morelia ");

        jLabel2.setFont(new java.awt.Font("Times New Roman", 3, 18)); // NOI18N
        jLabel2.setText("el cual saldrá el 20 de junio 2024. ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFConsulta14.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFConsulta14().setVisible(true);
            }
        });
    }
