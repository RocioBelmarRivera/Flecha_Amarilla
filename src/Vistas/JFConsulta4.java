...
public class JFConsulta4 extends javax.swing.JFrame {
    ...
    private void lee_datos() {
        ...
        try {
            //3.leer los datos
            resultados = modelos.busca_objetos_model3();
            //4. limpiar tabla
            limpiar_tabla();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("4-  Mostrar todos los datos personales de los pasajeros únicamente niños.  ");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Pasajero", "id_pasajero", "nombre", "apellido_p", "apellido_m", "correo"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFConsulta4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFConsulta4().setVisible(true);
            }
        });
    }
