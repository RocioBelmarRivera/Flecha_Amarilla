...
public class JFConsulta7 extends javax.swing.JFrame {
    ...
    private void lee_datos() {
        ...
        try {
            //3.leer los datos
            resultados = modelos.busca_objetos_model6();
            //4. limpiar tabla
            limpiar_tabla();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("7- Muestre el nombre de la terminal que es parada de cualquier ");

        jLabel2.setFont(new java.awt.Font("Times New Roman", 3, 18)); // NOI18N
        jLabel2.setText("ruta y muestre de que ruta es parada.   ");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "km", "costo", "dia", "mes", "año", "id_origen", "id_destino", "nombre"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFConsulta7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFConsulta7().setVisible(true);
            }
        });
    }
